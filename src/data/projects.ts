...
export const projects: Project[] = [
  ...
  },
  {
    ...
    problem:
      'LangGraph multi-agent support triage where every reply is grounded in retrieved evidence or it doesn’t go out — hybrid BM25 + dense retrieval, domain specialists with mandatory citations, and a programmatic critic that verifies every hard fact.',
  ...
  },
  {
    ...
    tag: 'Edge AI',
    problem:
      'Edge-native bot detection that classifies every HTTP request through a 5-stage ML cascade — vector fingerprinting, heuristics, and LLM fallback — running entirely on Cloudflare’s free tier with zero external infrastructure.',
